<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="FoodApp.User.Cart" %>
            ...
            <asp:Repeater ID="rCartItem" runat="server" onItemCommand="rCartItem_ItemCommand" OnItemDataBound="rCartItem_ItemDataBound">
                ...
                <ItemTemplate>
                       <tr>
                           ...
                           <td><asp:Label ID="lblPrice" runat="server" Text='<%# Eval("Price") %>'></asp:Label> DT
                           ...
                           <td> <asp:Label ID="lblTotalPrice" runat="server"></asp:Label> DT</td>
                           <td>
                ...
                <FooterTemplate>
                    <tr>
                        ...
                        <td><% Response.Write(Session["grandTotalPrice"]); %> DT </td>
                        <td></td>
                    </tr>
                    <tr>
