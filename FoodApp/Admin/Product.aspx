<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="FoodApp.Admin.Product" %>
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                     ...
                                     <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtQuantity" runat="server" CssClass="form-control"
                                                ...
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
                                                    ErrorMessage="Quantity mustn't be negative" ForeColor="Red" Display="Dynamic"
                                                    SetFocusOnError="true" ControlToValidate="txtQuantity"
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div>
                                                <asp:DropDownList ID="ddlCategories" runat="server" CssClass="form-control" DataTextField="Name"
                                                    DataValueField="CategoryId" DataSourceID="SqlDataSource1"
